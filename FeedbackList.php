              ...
              <ul class="site-menu js-clone-nav mx-auto d-none d-lg-block">
                ...
                <li class="has-children active">
                  ...
                  <ul class="dropdown">
                    ...
                    <li class="active"><a href="FeedbackList.php">Customer Feedback</a></li>
                  </ul>
                </li>
                <li class="has-children">
                  <a>Profile</a>
            ...
            <form action=" " class="p-5 bg-white">
              <div class="row form-group">                
                ...
                <hr>
                  ...
                  if ($count == 0) 
                  {
                    echo "<td colspan='7'>No Feedback yet.</td>";
                  }
                  else
                  {
                    echo "
                    <tr>
                      ...
                      <th style='padding:0px 10px 15px 10px;'>Customer Name</th>
                      <th style='padding:0px 10px 15px 10px;'>Profile</th>
                      <th style='padding:0px 10px 15px 10px;'>Feedback</th>
                    ...
                    { 
                      ...
                      <tr>
                        <td>$customerid</td>
                        <td>$customername</td>
                        <td><img src='$profile' alt='CustomerPhoto' class=' mb-3' width='70px' height='70px'></td>
                        <td>$feedback</td>
                        <td><a href='FeedbackDelete.php?customerid=$customerid' class='btn btn-primary py-2 px-3 text-white' style='border-radius:12px;'>Delete</a></td><tr>";
                    }
                  } ?>                     
                </table>  <hr> 
                </div>
