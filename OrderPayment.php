...
{
  $status = "CHECKED";
  $update = "UPDATE payment SET checkstatus = '$status' WHERE paymentid = '$paymentid'";
  $runupdate = mysqli_query($connect, $update);

  echo "<script>window.alert('Payment Checked')</script>";
            ...
            <form action="" class="p-5 bg-white" method="POST">
              ...
              <div class="row form-group">                
                <div class="col-md-12">
                  ...
                  <input type="text" class="form-control" value="<?php echo $array['nameoncard']; ?>" readonly>
                </div>
              </div>
              ...
              <div class="row form-group">                
                <div class="col-md-12">
                  ...
                  <input type="text" class="form-control" value="<?php echo $array['cardno']; ?>" readonly>
                </div>
              </div>
              ...
              <div class="row form-group">
                <div class="col-md-6 mb-3 mb-md-0">
                  ...
                  <input type="text" class="form-control" value="<?php echo $array['expmonth']; ?>" readonly>
                </div>
                <div class="col-md-6">
                  <label class="text-black">Expire Year</label>
                  <input type="text" class="form-control" value="<?php echo $array['expyear']; ?>" readonly>
                </div>
              </div>
              ...
              <div class="row form-group">                
                <div class="col-md-12">
                  ...
                  <input type="text" class="form-control" value="<?php echo $array['cvv']; ?>" readonly>
                </div>
              </div>
