...
if(isset($_POST['btnlogin']))
{
  ...
  {
    $select = "SELECT * FROM customer WHERE username = '$username' AND password = '$hashedpassword'";
    ...
    if ($count == 1)
    {
      ...
      echo "<script>window.location='ScheduleDisplay.php'</script>";
    }
    else
    {
          ...
          <div class="col-12 col-md-10 d-none d-xl-block">
            <nav class="site-navigation position-relative text-right" role="navigation">
              ...
              <ul class="site-menu js-clone-nav mx-auto d-none d-lg-block">
                ...
                <li class="active"><a href="CustomerRegistration.php">Register</a></li>
              </ul>
            </nav>
          </div>
      ...
      <div class="container">
        <div class="row align-items-center justify-content-center text-center">
          ...
          <div class="col-md-8" data-aos="fade-up" data-aos-delay="400">
            <h1 class="text-white font-weight-light text-uppercase font-weight-bold">Customer Login</h1>
            <p class="breadcrumb-custom"><a href="index.html">Home</a> <span class="mx-2">&gt;</span> <span>Login</span></p>
          </div>
        </div>
      </div>
    </div>  
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-7 mb-5">
                ...
                <form action="CustomerLogin.php" class="p-5 bg-white" method="POST">
                  ...
                  <div class="row form-group">                
                    <div class="col-md-12">
                      ...
                      <input type="text" class="form-control" name="txtcususername" required>
                    </div>
                  </div>
                  ...
                  <div class="row form-group">                
                    <div class="col-md-12">
                      ...
                      <input type="password" class="form-control" name="txtcuspassword" id="myinput" required>
                  ...
                  <div class="row form-group">
                    <div class="col-md-12">
                      <label class="text-black">Not a member? <a href="CustomerRegistration.php">Sign in now!</a></label>
                    </div>
                  </div>
