                    ...
                    <hr>
                      ...
                      else
                      {
                        ...
                        { 
                          ...
                          echo"
                          <tr>
                            <td style='padding-bottom:15px;'>$scheduleid</td>
                            <td>$freight</td>
                            <td>$departuredate</td>
                            <td>$arrivaldate</td>
                            <td>$from</td>
                          ...
                          if($scheduleid != '')
                          {
                            echo "<td><a href='ScheduleUpdate.php?scheduleid=$scheduleid' class='fa fa-pencil' title='Edit'></a> | 
                              <a href='ScheduleDelete.php?scheduleid=$scheduleid' class='fa fa-trash' title='Delete'></a></td>
                            </tr>";                      
                          }
