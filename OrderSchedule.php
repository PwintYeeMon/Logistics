...
if(isset($_REQUEST['freightid']))
{
  ...
  if(isset($_REQUEST['scheduleid']))
  {
    ...
    $select = "SELECT * FROM freight f, schedule s WHERE f.freightid = s.freightid 
                AND f.freightid = '$freightid' AND s.scheduleid = '$scheduleid'";
    $run = mysqli_query($connect, $select);
            ...
            <form action=" " class="p-5 bg-white" method="POST">
              ...
              <div class="row form-group">
                ...
                <div class="col-md-12">
                  ...
                  ?>
                  <input type="text" class="form-control" value="<?php echo  $freighttype.' - '.$duration; ?>" readonly>               
                </div>
              </div>
              ...
              <div class="row form-group">
                ...
                <div class="col-md-6 mb-3 mb-md-0">
                  ...
                  <input type="text" class="form-control" value="<?php echo $array['departuredate']; ?>" readonly>
                </div>
              
                <div class="col-md-6">
                  <label class="text-black">Arrival Date</label>
                  <input type="text" class="form-control" value="<?php echo $array['arrivaldate']; ?>" readonly>
                </div>
              ...
              <div class="row form-group">
                ...
                <div class="col-md-12">
                  ...
                  <input type="text" class="form-control" value="<?php echo $array['price']; ?>" readonly>
                </div>
              </div>
