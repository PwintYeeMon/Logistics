...
if (isset($_POST['btnupdate'])) 
{
  ...
  if ($array['password'] != $hashedpassword) 
  {
              ...
              <ul class="site-menu js-clone-nav mx-auto d-none d-lg-block">
                ...
                <li class="has-children active">
                  ...
                  <ul class="dropdown">
                    ...
                    <li class="active"><a href="UpdateCustomer.php">Update Profile</a></li>
      ...
      <div class="container">
        <div class="row align-items-center justify-content-center text-center">
          ...
          <div class="col-md-8" data-aos="fade-up" data-aos-delay="400">
            ...
            <p class="breadcrumb-custom"><a href="index.html">Profile</a> <span class="mx-2">&gt;</span> <span>Update</span></p>
          </div>
        </div>
      </div>
    </div>  
            ...
            <form action=" " class="p-5 bg-white" method="POST">             
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  ...
                  <input type="text" class="form-control" name="txtcustype" value="<?php echo $array['customertype']; ?>" readonly>
                </div>
              </div>
              ...
              <div class="row form-group">
                <div class="col-md-6 mb-3 mb-md-0">
                  ...
                  <input type="text" class="form-control" name="txtcusname" value="<?php echo $array['customername']; ?>" required>
                </div>
                <div class="col-md-6">
                  <label class="text-black">UserName</label>
                  <input type="text" class="form-control" name="txtcususername" value="<?php echo $array['username']; ?>" readonly>
                </div>
              </div>
              ...
              <div class="row form-group">                
                <div class="col-md-12">
                  ...
                  <input type="date" class="form-control" name="txtcusdob" value="<?php echo $array['dob']; ?>" readonly>
                </div>
              </div>
              ...
              <div class="row form-group">
                <div class="col-md-6 mb-3 mb-md-0">
                  ...
                  <input type="text" class="form-control" name="txtcusphoneno" value="<?php echo $array['phoneno']; ?>" required>
                </div>
                <div class="col-md-6">
                  <label class="text-black">Email</label>
                  <input type="email" class="form-control" name="txtcusemail" value="<?php echo $array['email']; ?>" required>
                </div>
              </div>
              ...
              <div class="row form-group">
                ...
                <div class="col-md-12">
                  ...
                  <input type="text" class="form-control" name="txtadd1" value="<?php echo $array['address1']; ?>" required>
                </div>
              </div>
              ...
              <div class="row form-group">
                ...
                <div class="col-md-12">
                  ...
                  <input type="text" class="form-control" name="txtadd2" value="<?php echo $array['address2']; ?>">
                </div>
              </div>
              ...
              <div class="row form-group">
                ...
                <div class="col-md-12">
                  ...
                  <input type="text" class="form-control" name="txtcity" value="<?php echo $array['city']; ?>" required>
                </div>
              </div>
              ...
              <div class="row form-group">
                <div class="col-md-6 mb-3 mb-md-0">
                  ...
                  <input type="text" class="form-control" name="txtstate" value="<?php echo $array['state']; ?>" required>
                </div>
                <div class="col-md-6">
                  <label class="text-black">Postcode</label>
                  <input type="text" class="form-control" name="txtcuspostcode" value="<?php echo $array['postcode']; ?>" required>
                </div>
              </div>
              ...
              <div class="row form-group">
                ...
                <div class="col-md-12">
                  ...
                  <select name="txtcountry" class="form-control" required>
                    <option value="<?php echo $array['country']; ?>" selected hidden><?php echo $array['country']; ?></option>
