...
if(isset($_REQUEST['recipientid']))
{
  ...
  $select = "SELECT * FROM recipient WHERE recipientid = $recipientid";
  $run = mysqli_query($connect, $select);
...
if(isset($_POST['btnback']))
{
  ...
  echo "<script>window.location='ItemList.php?orderid=$orderid'</script>";
}
?>
<html lang="en">
  <head>
            ...
            <form action=" " class="p-5 bg-white" method="POST">
              ...
              <div class="row form-group">
                ...
                <div class="col-md-6">
                  ...
                  <input type="email" class="form-control" value="<?php echo $array['email']; ?>" readonly>
                </div>
              </div>
