...
{
  $trackingid = $_POST['txttrackingid'];
      ...
      <div class="container">
        <div class="row align-items-center justify-content-center text-center">
          ...
          <div class="col-md-8" data-aos="fade-up" data-aos-delay="400">
            <h1 class="text-white font-weight-light text-uppercase font-weight-bold">Tracking</h1>
            <p class="breadcrumb-custom"><a href="index.html">Services</a> <span class="mx-2">&gt;</span> <span>Tracking</span></p>
          </div>
        </div>
      </div>
    </div> 
                ...
                <form action=" " class="p-5 bg-white" method="POST">
                  ...
                  <div class="row form-group">                
                    <div class="col-md-12">
                      ...
                      <input type="text" class="form-control" name="txttrackingid" placeholder="Enter Tracking Number" required>
                    </div>
                  </div>

                  <div class="row form-group">
                    <div class="col-md-12">
                      <input type="submit" value="Search" name = "btnsearch" class="btn btn-primary py-2 px-4 text-white">
