...
if(isset($_POST['btnsave'])) 
{
  ...
  $add = "INSERT INTO schedule (freightid, departuredate, arrivaldate, country, destination, price, staffid, scheduledate)
  			VALUES ('$freightid', '$departure', '$arrival',  '$country', '$destination', '$price', '$staffid', '$date')";
            ...
            <nav class="site-navigation position-relative text-right" role="navigation">
              ...
              <ul class="site-menu js-clone-nav mx-auto d-none d-lg-block">
                ...
                <li class="has-children active">
                  <a href="">Schedule</a>
                  <ul class="dropdown">
                    <li class="active"><a href="Schedule.php">Schedule Entry</a></li>
            ...
            <form action=" " class="p-5 bg-white" method="POST">
              ...
              <div class="row form-group">
                ...
                <div class="col-md-12">
                  ...
                  if($count>0)
                  {
                    ...
                    echo "<option value='' disabled selected hidden>Choose Freight Type</option>";
              ...
              <div class="row form-group">
                ...
                <div class="col-md-6 mb-3 mb-md-0">
                  ...
                  <input type="date" class="form-control" name="txtdeparture" required>
                  
                </div>
              
                <div class="col-md-6">
                  <label class="text-black">Arrival Date</label>
                  <input type="date" class="form-control" name="txtarrival" required>
                </div>
              ...
              <div class="row form-group">
                ...
                <div class="col-md-12">
                  ...
                  <input type="number" class="form-control" name="txtprice"  step="0.001" min="0.001" required>
                </div>
              </div>

              <div class="row form-group">
                <div class="col-md-12">
                  <input type="submit" value="Save" name = "btnsave" class="btn btn-primary py-2 px-4 text-white">
